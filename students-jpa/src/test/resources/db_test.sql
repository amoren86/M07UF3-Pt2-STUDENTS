...
INSERT INTO modules (code, cycle_code, name) VALUES ('M14', 'DAM', 'Formació en centres de treball');
INSERT INTO modules (code, cycle_code, name) VALUES ('M01', 'DAW', 'Sistemes informàtics'); 
INSERT INTO modules (code, cycle_code, name) VALUES ('M02', 'DAW', 'Bases de dades'); 
INSERT INTO modules (code, cycle_code, name) VALUES ('M03', 'DAW', 'Programació');
INSERT INTO modules (code, cycle_code, name) VALUES ('M04', 'DAW', 'Llenguatges de marques i sistemes de gestió d''informació');
INSERT INTO modules (code, cycle_code, name) VALUES ('M05', 'DAW', 'Entorns de desenvolupament'); 
INSERT INTO modules (code, cycle_code, name) VALUES ('M06', 'DAW', 'Desenvolupament web en l''entorn client');
INSERT INTO modules (code, cycle_code, name) VALUES ('M07', 'DAW', 'Desenvolupament web en l''entorn servidor'); 
INSERT INTO modules (code, cycle_code, name) VALUES ('M08', 'DAW', 'Desplegament d''aplicacions web');
INSERT INTO modules (code, cycle_code, name) VALUES ('M09', 'DAW', 'Disseny d''interfícies web'); 
INSERT INTO modules (code, cycle_code, name) VALUES ('M10', 'DAW', 'Formació i orientació laboral');
INSERT INTO modules (code, cycle_code, name) VALUES ('M11', 'DAW', 'Empresa i iniciativa emprenedora'); 
INSERT INTO modules (code, cycle_code, name) VALUES ('M12', 'DAW', 'Projecte de desenvolupament d''aplicacions web');
INSERT INTO modules (code, cycle_code, name) VALUES ('M13', 'DAW', 'Formació en centres de treball');
